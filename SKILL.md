...
name: slc-skill
description: >-
  學習共同體哲學視角的公開課課例探究與插圖簡報技能：以傾聽關係、互惠學習、言談權力、伸展跳躍任務、質性時間等 SLC 概念詮釋課堂中的學習事實，聚焦學生的語言、眼神、姿態、沉默與同伴互動，並將關鍵畫格重繪為日系水彩／抹茶綠繪本風格插圖，產出 16:9 PPTX 與互動式 HTML 簡報。當使用者說「學共觀課」「學習共同體課例探究」「描述詮釋反思」「伸展跳躍」「傾聽關係」「抹茶綠簡報」「觀課簡報要重繪插圖」「幫我做課例研究簡報」時使用。若重點在字幕校正、逐字稿引用的正確性，或要產出議課播放用的燒字幕影片片段，改用 classroom-video-analysis。
---
